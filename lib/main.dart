            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text("Doctor's appointment in 2 minutes",style: TextStyle(fontSize: 28,fontWeight: FontWeight.w900 ),),
                    SizedBox(height: 5),
                    Text("Finding a doctor was never so easy",style: TextStyle(fontSize: 22,fontWeight: FontWeight.w400 ),),
                  ],
                ),
              ),
             Positioned(
